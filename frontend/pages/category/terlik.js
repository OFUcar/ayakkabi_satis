...
export default function TerlikCategory() {
  ...
  const fetchProducts = async () => {
    ...
    try {
      ...
      const slipperProducts = allProducts.filter(product => 
        product.category === 'terlik' || 
        product.name.toLowerCase().includes('terlik') ||
        product.name.toLowerCase().includes('sandalet') ||
        product.tags?.includes('terlik')
      );
  ...
  const filteredProducts = products.filter(product => {
    ...
    const matchesPrice = priceRange === 'all' || 
      ...
      (priceRange === '300+' && product.price > 300);
  ...
  return (
    <>
      <Head>
        <title>Terlik & Sandalet - STEP Golden Shoes</title>
        <meta name="description" content="Terlik ve sandalet modelleri, rahat ve şık tasarımlar" />
      </Head>
        ...
        <div className="bg-dark-950 py-8">
          <div className="max-w-7xl mx-auto px-4">
            ...
            <p className="text-gray-400 text-lg">
              Rahat ve şık terlik koleksiyonumuz
            </p>
          </div>
        </div>
            ...
            {loading ? (
              ...
              <div className="text-center py-20">
                ...
                <h3 className="text-xl font-semibold text-white mb-2">
                  Henüz terlik bulunmuyor
                </h3>
                <p className="text-gray-400 mb-6">
                  Yakında terlik koleksiyonumuz eklenecek
                </p>
              </div>
            )}
          </div>
