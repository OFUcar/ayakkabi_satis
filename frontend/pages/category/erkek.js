...
export default function ErkekCategory() {
  ...
  const fetchProducts = async () => {
    ...
    try {
      ...
      const menProducts = allProducts.filter(product => 
        ...
        product.name.toLowerCase().includes('erkek') ||
        product.tags?.includes('erkek')
      );
  ...
  return (
    <>
      <Head>
        <title>Erkek Ayakkabıları - STEP Golden Shoes</title>
        <meta name="description" content="Erkek ayakkabı modelleri, spor ve klasik tasarımlar" />
      </Head>
        ...
        <div className="bg-dark-950 py-8">
          <div className="max-w-7xl mx-auto px-4">
            ...
            <p className="text-gray-400 text-lg">
              Spor ve klasik erkek ayakkabı koleksiyonumuz
            </p>
          </div>
        </div>
            ...
            {loading ? (
              ...
              <div className="text-center py-20">
                ...
                <h3 className="text-xl font-semibold text-white mb-2">
                  Henüz erkek ayakkabısı bulunmuyor
                </h3>
                <p className="text-gray-400 mb-6">
                  Yakında erkek ayakkabı koleksiyonumuz eklenecek
                </p>
              </div>
            )}
          </div>
